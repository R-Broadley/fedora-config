...
tar xfj Zotero-4.0.29.10_linux-x86_64.tar.bz2 -C /opt
...
rm Zotero-4.0.29.10_linux-x86_64.tar.bz2


# Shell extensions
# From repos
dnf install -y gnome-shell-extension-{alternate-tab,common,drive-menu,openweather,places-menu,topicons-plus}
# dash-to-dock
